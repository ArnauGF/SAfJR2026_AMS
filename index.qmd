...
$$ \require{color}\scriptsize\begin{cases}
        ...
        & =(\beta_0^3 + b_{0i}^3) + \sum_{j=1}^3(\beta_{j}^3 + b_{ji}^3)B_j^3(t,\lambda)  + \varepsilon_{3i}(t),\\
        ...
        & = (\beta_0^5 + b_{0i}^5) + \sum_{j=1}^3(\beta_{j}^5 + b_{ji}^5)B_j^5(t,\lambda)   + \varepsilon_{5i}(t),
    \end{cases}$$
</div>
