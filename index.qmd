...
<div style="position:absolute; top:13%; left:0%;" class="fragment fade-in">
  - Decision curves allow [multiple $c$'s]{style="color:#EB589A;"} , but they are [not scoring rules]{style="color:#EB589A;"} 
</div>
...
<div style="position:absolute; top:13%; left:0%;" class="fragment fade-in-then-out">
- Shared-parameter [joint models]{style="color:#EB589A;"} using the same baseline data $\boldsymbol{X}_i$ and the longitudinal submodels:
...
- We extend the classical decision curve analysis defining [weighted decision curves]{style="color:#EB589A;"}.
...
## Contribution of the work {.background-slide}
...
- [IPW estimator]{style="color:#EB589A;"} tailored to [LRTC data]{style="color:#EB589A;"} 
...
<div style="position:absolute; top:13%; left:0%;" class="fragment fade-in">
- [Limitations]{style="color:#EB589A;"} of the work:
