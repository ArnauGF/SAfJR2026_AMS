...
<div style="position:absolute; top:13%; left:0%;" class="fragment fade-in">
  - BS, LogS and AUC quantify predictive accuracy, but not the consequences of decisions based on predictions 
  - BS, LogS and AUC do not account for the asymmetric harms of false-positives and false-negatives decisions
</div>
...
<div style="position:absolute; top:25%; left:20%;" class="fragment fade-in-then-out">
  <img src="images/table2.svg" style="width:75%; text-align:center;">
</div>
