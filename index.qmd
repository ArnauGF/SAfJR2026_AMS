...
* To reflect the [asymmetry between FP and FN]{style="color:#EB589A;"} in clinical context, we set [$c\in(0.1, 0.3)$]{style="color:#EB589A;"}
</div>


<div style="position:absolute; top:10%; left:12%;" class="fragment fade-in-then-out">
  <img src="images/w1.png" style="width:85%; text-align:center;">
</div>

<div style="position:absolute; top:10%; left:12%;" class="fragment fade-in-then-out">
  <img src="images/w2.png" style="width:85%; text-align:center;">
</div>

<div style="position:absolute; top:10%; left:12%;" class="fragment fade-in-then-out">
  <img src="images/w3.png" style="width:85%; text-align:center;">
</div>

<div style="position:absolute; top:10%; left:12%;" class="fragment fade-in-then-out">
  <img src="images/ws.png" style="width:85%; text-align:center;">
</div>
...
$$ \require{color}\scriptsize\begin{cases}
        ...
        & = (\beta_0^4 + b_{0i}^4) + (\beta_{1}^4 + b_{1i}^4)B_1^4(t,\lambda) +  (\beta_{2}^4 + b_{2i}^4)B_2^4(t,\lambda)  + \varepsilon_{4i}(t)
    \end{cases}$$
</div>
